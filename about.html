...
<div class="container">
    <div class="row-center">
        <div class="col-md-7">
            ...
            {% endif %}
            {% if site.layouts.abou.educationHistory %}
                <h3 class="title with-icon"><span class="fa fa-book cat-title"></span>Education History</h3>
                <ul class="timeline">
                    {% for education in site.layouts.abou.educationHistory %}
                        <li class="timeline-inverted">
        ...
        <div class="col-md-5">
            {% if site.layouts.abou.programmingSkills %}
                <h3 class="title with-icon"><span class="fa fa-code cat-title"></span> Programming Skills</h3>
                <div class="grid-block">
                    <ul class="list-unstyled list-skills">
                        {% for programmingSkill in site.layouts.abou.programmingSkills %}
                            <li>
            ...
            <div class="grid-block">
                <img src="http://restapi.amap.com/v3/staticmap?location=102.771387,25.085843&amp;zoom=15&amp;size=500*250&amp;markers=mid,,A:102.771387,25.085843&amp;key=4fbf0c0dfa89f726a84101e3a5d1bc50" style="border:0" frameborder="0" width="100%" height="100%">
            </div>
        </div>
    </div>
</div>
